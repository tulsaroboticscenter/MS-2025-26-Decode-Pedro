...
//    public HardwareMap hwmap;
    ...
    private final Pose BluestartPose = new Pose(130, 110.5, Math.toRadians(90)); // Start Pose of our robot.
    private final Pose BluescorePose = new Pose(86, 136, Math.toRadians(0));// Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose BluePrescorePose = new Pose(85, 135, Math.toRadians(0)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose BlueendPose = new Pose(50, 65, Math.toRadians(180)); //  End Position of the Robot
    ...
    public void buildPaths() {
        ...
        scorePreload =follower.pathBuilder()
                .addPath(new BezierCurve(startPose,new Pose(102,136),scorePose))
