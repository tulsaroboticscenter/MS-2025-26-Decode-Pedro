...
@Autonomous(name = "LongRed", group = "Examples")
public class RedLongPP extends LinearOpMode {
...
//    public HardwareMap hwmap;
    ...
    private final Pose scorePose = new Pose(82, 17, Math.toRadians(70)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    ...
    private final Pose endPose = new Pose(94, 50, Math.toRadians(70)); // 135 End Position of the Robot
