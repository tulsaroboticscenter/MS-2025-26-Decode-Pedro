...
//    public HardwareMap hwmap;
    ...
    private final Pose pickup2PoseEnd = new Pose(15, 59, Math.toRadians(180)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose pickup3PoseBegin = new Pose(45, 36, Math.toRadians(180)); // Lowest (Third Set) of Artifacts from the Spike Mark.
