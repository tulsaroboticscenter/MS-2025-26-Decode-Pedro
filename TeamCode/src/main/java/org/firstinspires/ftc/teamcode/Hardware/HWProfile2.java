...
//            imu.initialize(new IMU.Parameters(orientationOnRobot));
        ...
        motorShooter.setPIDFCoefficients(DcMotorEx.RunMode.RUN_USING_ENCODER, new PIDFCoefficients(210, 0.0, 0.0, 13.3));
        ...
        motorShooterTop.setPIDFCoefficients(DcMotorEx.RunMode.RUN_USING_ENCODER, new PIDFCoefficients(210, 0.0, 0.0, 13.3));
